...
tuner = MyTuner(
    ...
    directory='/leonardo/home/userexternal/fgalavot/project/package/L1Half',               # Directory to store results
...
for i in range(MODELS_TO_PASS):
    ...
    best_models[i].save(f'/leonardo/home/userexternal/fgalavot/project/package/L1Half/best_models_backup/model_{i}.keras')
...
for i in range(MODELS_TO_PASS):
    ...
    best_models[i].save(f'/leonardo/home/userexternal/fgalavot/project/package/L1Half/best_models/model_{i}.keras')

    print(f"\n--- SAVING MODEL {i}'S HISTORY ---")

    serializable_history = make_serializable(history[i].history)

    with open(f'/leonardo/home/userexternal/fgalavot/project/package/L1Half/best_models/model_{i}_history.json', 'w') as f:
...
marcello.save('/leonardo/home/userexternal/fgalavot/project/package/L1Half/best_models/marcello.keras')

print("--- SAVING BENCHMARK MODEL'S HISTORY ---")

with open('/leonardo/home/userexternal/fgalavot/project/package/L1Half/best_models/history_marcello.json', 'w') as f:
