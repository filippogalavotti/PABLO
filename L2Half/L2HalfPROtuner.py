...
uploaded_train_dataset = tf.data.Dataset.load("/leonardo/home/userexternal/fgalavot/project/package/HalfDataset/train_dataset")

print("> Uploading test_dataset")
uploaded_test_dataset = tf.data.Dataset.load("/leonardo/home/userexternal/fgalavot/project/package/HalfDataset/test_dataset")
...
tuner = MyTuner(
    ...
    directory='/leonardo/home/userexternal/fgalavot/project/package/L2Half',                # Directory to store results
...
for i in range(MODELS_TO_PASS):
    ...
    best_models[i].save(f'/leonardo/home/userexternal/fgalavot/project/package/L2Half/best_models_backup/model_{i}.keras')
...
for i in range(MODELS_TO_PASS):
    ...
    best_models[i].save(f'/leonardo/home/userexternal/fgalavot/project/package/L2Half/best_models/model_{i}.keras')
    ...
    with open(f'/leonardo/home/userexternal/fgalavot/project/package/L2Half/best_models/model_{i}_history.json', 'w') as f:
...
marcello.save('/leonardo/home/userexternal/fgalavot/project/package/L2Half/best_models/marcello.keras')

print("--- SAVING BENCHMARK MODEL'S HISTORY ---")

with open('/leonardo/home/userexternal/fgalavot/project/package/L2Half/best_models/history_marcello.json', 'w') as f:
