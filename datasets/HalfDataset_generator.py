...
def directory_to_dataset(directory_path, training):
    ...
    for filename in os.listdir(directory_path):
        if filename.endswith('.npz'):
            ...
            # Define the channels you are interested in
            channels_of_interest = [0, 1, 4, 5, 8, 9, 12, 13, 16, 17]

            data_angles = data_angles[:, channels_of_interest]
...
train_dataset.save("/home/bs_fgalavotti/project/HalfDataset/train_dataset")

print("> Downloading test_dataset")
test_dataset.save("/home/bs_fgalavotti/project/HalfDataset/test_dataset")